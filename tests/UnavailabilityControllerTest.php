...
//    {
//        $organiser = $this->userRepository->findOneBy(['id' => 56]);
//
//        $room = $this->roomRepository->findOneById(['id' => 16 ]);
//
...
//
//        $this->assertNotNull($this->unavailabilityRepository->findUpcomingUnavailabilitiesByOrganiser($organiser));
//
